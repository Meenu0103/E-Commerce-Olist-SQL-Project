...
-- 4. Sellers with best delivery performance
select 
    oi.seller_id,
...
-- 5. Sellers with worst delivery delays
select 
    oi.seller_id,
    avg(extract(epoch from 
        (o.order_delivered_carrier_date - o.order_approved_at)) / 86400
...
-- 6. States with slowest delivery times
select 
    c.customer_state, 
...
-- 7. Delivery time distribution per category
select 
