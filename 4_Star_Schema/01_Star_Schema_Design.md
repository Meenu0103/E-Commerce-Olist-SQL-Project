...
| payment_value | Total payment received |
...
Dim_Products — — Fact_Order_Items — — Dim_Sellers
           ...
           Dim_Order_Payments
             ...
             Dim_Order_Reviews
                      |
                      |
        Dim_Geolocation (supports both customers + sellers)
                      |
                      |
  Dim_Product_Category_Translation (supports products)
